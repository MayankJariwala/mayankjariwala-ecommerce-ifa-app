		...
		if (validateLogin()) {
			...
			authRequest.login(login_model).then(value => {
				if (value instanceof LoginResponseModel) {
					...
					window.location = routes.products.list;
			...
			<div className="container">
				<div className="row justify-content-center">
					<div className="col-md-8 col-lg-6 col-xl-5">
								...
								<div className="row">
									<div className="col-7">
										<div className="text-primary p-4">
											<h5 className="text-primary text-center">E-Commerce Admin Portal</h5>
										</div>
									</div>
								</div>
							</div>
						...
						<FooterComponent>
							<p><Link to={"/reset-password"} className="font-weight-medium text-primary">Forgot your password?</Link>
							</p>
						</FooterComponent>
					</div>
				</div>
